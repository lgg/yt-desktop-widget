# 0009 - Re-enable installer packaging after the portable-only test cycle
...
- Migrated from Beads issue: `ytw-5v6.4`
- Type: Task
- Priority: P3
- Created: 2026-03-11T03:29:02Z
...
Portable-only builds are the current default for fast testing. Revisit Tauri bundling and restore installer/setup packaging when packaging validation becomes an active goal again.
...
- Deploy/config: Potentially affected.
...
- parent-child: ytw-5v6 (created 2026-03-11T06:29:02Z)
