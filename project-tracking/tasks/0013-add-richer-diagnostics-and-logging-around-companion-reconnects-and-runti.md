# 0013 - Add richer diagnostics and logging around Companion reconnects and runtime state
...
- Migrated from Beads issue: `ytw-5v6.7`
- Type: Task
- Priority: P3
- Created: 2026-03-11T04:33:44Z
- Updated: 2026-03-11T04:36:18Z
- Assignee: Unassigned
- Created by: unknown

## Context

The architecture notes leave room for better diagnostics around Companion reconnect behavior and runtime state transitions. Add practical logging or inspection hooks that help debug connection failures, auth problems, and window/runtime regressions without relying on guesswork.
...
- parent-child: ytw-5v6 (created 2026-03-11T07:33:44Z)
