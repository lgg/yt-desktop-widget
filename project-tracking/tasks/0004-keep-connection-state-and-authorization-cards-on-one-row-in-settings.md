# 0004 - Keep Connection State and Authorization cards on one row in settings
...
- Migrated from Beads issue: `ytw-l48.3`
- Type: Bug
- Priority: P2
- Created: 2026-03-11T03:15:55Z
- Updated: 2026-03-11T03:26:38Z
- Assignee: Unassigned
- Created by: unknown

## Context

In the API / Connection section, the Connection State and Authorization summary cards should stay side by side on a single row at the current settings window width instead of stacking into separate rows.
...
- parent-child: ytw-l48 (created 2026-03-11T06:15:54Z)
