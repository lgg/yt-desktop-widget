# 0001 - Current Architecture Decisions
...
Review individual decisions when future tasks change platform support, Companion integration, window modes, packaging, or tracking workflow.
